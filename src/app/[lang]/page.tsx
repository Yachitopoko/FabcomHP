            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full">
                        <Link href={`/${lang}/contact`} className="flex items-center justify-center gap-2 px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-full font-medium transition-all transform hover:scale-105 shadow-[0_0_40px_-10px_rgba(99,102,241,0.5)] w-full sm:w-auto">
                            無料の戦略セッションを予約 <ArrowRight className="w-4 h-4" />
                        </Link>
                        <Link href={`/${lang}/services`} className="flex items-center justify-center gap-2 px-8 py-4 bg-white/5 hover:bg-white/10 text-white rounded-full font-medium border border-white/10 transition-all w-full sm:w-auto">
                            サービス詳細を見る
                        </Link>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map((feature, idx) => (
                            <div
                                key={idx}
                                className="glass p-8 rounded-2xl hover:bg-white/[0.08] transition-all duration-300 hover:-translate-y-2 border border-white/5 group"
                            >
