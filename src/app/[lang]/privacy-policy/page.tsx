...
export default async function PrivacyPolicyPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <section className="py-24 max-w-3xl mx-auto px-6 relative">
            <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center">プライバシーポリシー</h1>

            <div className="prose prose-invert prose-zinc max-w-none glass p-8 md:p-12 rounded-3xl border border-white/5 space-y-8">
                <div>
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4 text-white">2. 取得する情報</h2>
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4 text-white">3. 利用目的</h2>
                    <p className="text-zinc-400 leading-relaxed mb-2">
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4 text-white">4. 管理方法</h2>
                    <p className="text-zinc-400 leading-relaxed">
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4 text-white">5. お問い合わせ窓口</h2>
                    <p className="text-zinc-400 leading-relaxed">
