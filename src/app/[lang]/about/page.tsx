    ...
    return (
        <>
            <section className="py-24 max-w-4xl mx-auto px-6">
                <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center text-gradient">会社概要</h1>

                <div className="glass p-8 md:p-12 rounded-3xl border border-white/5 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-white/10 pb-8">
                        <div className="text-zinc-500 font-medium">屋号 / チーム名</div>
                        <div className="md:col-span-2 font-bold text-lg">Fabcom</div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-white/10 pb-8">
                        <div className="text-zinc-500 font-medium">事業内容</div>
                        <div className="md:col-span-2 leading-relaxed text-zinc-300">
                            Webサイト制作・運用<br />
                            LP制作およびLPO支援<br />
                            リテンション向上施策の企画・実行<br />
                            Meta広告等デジタル広告運用<br />
